...
Using the Polkadot chain as an example, assume there are two transactions – one
Stellar transaction and one Polkadot transaction – whose authorizations must be
atomic. In other words, if one is authorized the other must be authorized.

The Stellar signer who must authorize the Stellar transaction is:
`GCJTVHANCXXALNGBBE3P6WK3RUGG26P4P576SFALFQKU7MNPCI43UQND`.
The Stellar transaction hash is:
`50ca902db4674e8d6401588ae055b1cd0ef18e691e5686318e939d02c1362b2f`.

The Polkadot signer who must authorize the Polkadot transaction is:
`0xee67b41e02360798a051edcafa1c390357881bd1ad70b37de03aba140f26a267`
The Polkadot transaction hash is:
`c46727a5a86d698d42861f0a43094ec44f6af0b347def348fa24c173cc265a36`.

To authorize the transactions both parties must sign their respective
transactions, but the signature for the Polkadot transaction must also be 
attached to the Stellar transaction for it to be authorized. The Stellar signer 
may sign their transaction first and give it to the Polkadot signer, knowing 
that the transaction is not authorized until the Polkadot signer attaches their 
signature to it. When the Polkadot signer attaches their signature and submits 
the transaction they reveal the signature of the Polkadot transaction ensuring 
that both transactions can be authorized.

The Stellar signer signs the Stellar transaction producing signature (64 bytes):
`90f2571f6fc82f071a91ff4c30463e14c1cc3e0c7825587fe54d2ffc8e9ef1818b4d089a9c5ee46a2eb283fb86fbaedd68c71e6322b9395850d3f1a0ae5bf108`

The Polkadot signer signs the Polkadot transaction producing signature (64 bytes):
`8542a2b4a5e435233569c9a1a3cc5298ce36fc854fc74285df5bf4d2cd824f1d3a2ecbc691b053912e42fbdd0777a54efe2ffc606d0085a52fc689eb907b4202`
