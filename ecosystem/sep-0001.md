...
ORG_DBA | meme | (may not apply) [DBA](https://www.entrepreneur.com/encyclopedia/doing-business-as-dba) of your organization
...
Field | Requirements | Description
------|--------------|------------
name | PePe-stellar | Full legal name
...
issuer | `GDVR5OJNIDGXW3S7G7JTMXZQK7JIF2VC5KF44M3YZFDDE4TSO7FBS4UW` | Token issuer Stellar public key
status | only 100M | Status of token. One of `live`, `dead`, `test`, or `private`. Allows issuer to mark whether token is dead/for testing/for private use or is live and should be listed in live exchanges.
display_decimals | 2 | Preference for number of decimals to show when a client displays currency balance
name | PePe | A short name for the token
desc | for fun meme | Description of token and what it represents
